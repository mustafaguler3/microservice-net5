...
namespace FreeCourse.Web.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<Response<bool>> SignIn(SigninInput signin)
        {
            ...
            if (token.IsError)
            {
                var responseContent = await token.HttpResponse.Content.ReadAsStringAsync();//string olarak okuyoruz
            ...
            userInfoRequest.Address = disco.UserInfoEndpoint;//userinfo ya istek yap
            ...
            //identity model kullanmasak bu işlemlerin hepsini elle yapardık
